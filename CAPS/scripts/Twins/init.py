...
for node in nodes_A:
    os.system("ssh %s \" /usr/local/bin/rapl -t 0.5 -m -f /home/pzou/projects/haswell/co_scheduling/results/Real_Run/Cluster/%s/Twins/%s/%s_p%d.log > /dev/null 2>&1 &\" &"%(node,sys.argv[1], sys.argv[2],node,power_total))
