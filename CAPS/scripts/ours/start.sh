...
if [ ! -d /home/pzou/projects/haswell/co_scheduling/results/Real_Run/Cluster/$power/ours/$times ]; then
    mkdir /home/pzou/projects/haswell/co_scheduling/results/Real_Run/Cluster/$power/ours/$times
fi
...
./end.py $power
cp ./job_running_p${power}.log /home/pzou/projects/haswell/co_scheduling/results/Real_Run/Cluster/$power/ours/$times/
