...
FRIST=$(qsub  bt-mz.C.qsub)
echo $FRIST
SECOND=$(qsub -W depend=afterany:$FRIST sp-mz.C.qsub)
echo $SECOND
THIRD=$(qsub -W depend=afterany:$SECOND lu-mz.C.qsub)
echo $THIRD
...
# echo $SIXTH
SEVENTH=$(qsub -W depend=afterany:$FIFTH miniAero.qsub)
echo $SEVENTH
