...
echo $SECOND
THIRD=$(qsub -W depend=afterany:$SECOND CloverLeaf-bm128.qsub)
echo $THIRD
SEVENTH=$(qsub -W depend=afterany:$THIRD miniAero.qsub)
echo $SEVENTH
NINTH=$(qsub -W depend=afterany:$SEVENTH TeaLeaf-bm5.qsub)
echo $NINTH
FOURTH=$(qsub -W depend=afterany:$NINTH TeaLeaf-bm20.qsub)
echo $FOURTH
FIFTH=$(qsub -W depend=afterany:$FOURTH CloverLeaf-bm16.qsub)
echo $FIFTH
SIXTH=$(qsub -W depend=afterany:$FIFTH bt-mz.C.8.qsub)
echo $SIXTH
