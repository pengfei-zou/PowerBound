...
while [ $thNum -ge 8 ]; do
	...
	/usr/local/bin/rapl -c 0,12 -s 0.1 -f /home/pzou/projects/haswell/n02/stream/stream_${GOMP_CPU_AFFINITY}_$power.log 2>&1 1>/dev/null &
	OMP_NUM_THREADS=$thNum GOMP_CPU_AFFINITY="$socket1,$socket2" /home/pzou/software/STREAM/stream_c > /home/pzou/projects/haswell/n02/stream/stream_${GOMP_CPU_AFFINITY}_$power.data.txt
	#mpirun -np 1 /home/pzou/software/software-benchmark/NPB3.3.1-MZ/NPB3.3-MZ-MPI/bin/sp-mz.C.1	> /home/pzou/projects/haswell/n02/SP/SP_${GOMP_CPU_AFFINITY}_$power.data.txt	
	pkill rapl
