...
while [ $thNum -ge 2 ]; do
	...
	sudo OMP_NUM_THREADS=$thNum GOMP_CPU_AFFINITY="$socket1,$socket2" /home/pzou/software/STREAM/stream_c > /home/pzou/projects/haswell/n02/stream/stream_${GOMP_CPU_AFFINITY}_$freq.data.txt
