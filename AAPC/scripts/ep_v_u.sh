...
sudo OMP_NUM_THREADS=18 GOMP_CPU_AFFINITY="0-11,12-17" /home/pzou/software/software-benchmark/NPB3.3.1/NPB3.3-OMP-haswell/bin/ep.C.x > /home/pzou/projects/haswell/n02/EP/EP_${totoalPower}_u.data.t
sleep 5
# totoalPower=80
# sudo /usr/local/bin/mu_power_gadget -r 5.5
...
sudo OMP_NUM_THREADS=10 GOMP_CPU_AFFINITY="0-9" /home/pzou/software/software-benchmark/NPB3.3.1/NPB3.3-OMP-haswell/bin/ep.C.x > /home/pzou/projects/haswell/n02/EP/EP_${totoalPower}_u.data.t
sleep 5
