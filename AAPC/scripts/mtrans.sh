...
while [ $thNum -ge 2 ]; do
	...
	sudo OMP_NUM_THREADS=$thNum GOMP_CPU_AFFINITY="$socket1,$socket2" /home/pzou/software/software-benchmark/matrix_transpose/matrix_transpose.o 50000 50000 > /home/pzou/projects/haswell/n02/mtrans/mtrans_${GOMP_CPU_AFFINITY}_$freq.data.txt
