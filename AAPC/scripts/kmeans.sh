...
while [ $thNum -ge 2 ]; do
	...
	OMP_NUM_THREADS=$thNum GOMP_CPU_AFFINITY="$socket1,$socket2" /home/pzou/software/software-benchmark/NU-MineBench-3.0.1/KMeans/example -i /home/pzou/software/software-benchmark/NU-MineBench-3.0.1/KMeans/kmeans/edge -b -o > /home/pzou/projects/haswell/n02/kmeans/kmeans_${GOMP_CPU_AFFINITY}_$freq.data.txt
