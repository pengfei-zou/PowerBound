...
sudo /usr/local/bin/mu_power_gadget -2 47
sudo /usr/local/bin/mu_power_gadget -3 35
sudo OMP_NUM_THREADS=16 GOMP_CPU_AFFINITY="0-11,12-15" /home/pzou/software/software-benchmark/NPB3.3.1/NPB3.3-OMP-haswell/bin/ft.C.x > /home/pzou/projects/haswell/n02/FT/FT_${totoalPower}_u.data.txt
sleep 5
...
sudo /usr/local/bin/mu_power_gadget -2 35
sudo /usr/local/bin/mu_power_gadget -3 29
sudo OMP_NUM_THREADS=8 GOMP_CPU_AFFINITY="0-7" /home/pzou/software/software-benchmark/NPB3.3.1/NPB3.3-OMP-haswell/bin/ft.C.x > /home/pzou/projects/haswell/n02/FT/FT_${totoalPower}_u.data.txt
sleep 5
# totoalPower=80
...
sudo /usr/local/bin/mu_power_gadget -0 7.5
sudo /usr/local/bin/mu_power_gadget -1 6
sudo /usr/local/bin/mu_power_gadget -3 31.5
sudo /usr/local/bin/mu_power_gadget -4 25 
sudo OMP_NUM_THREADS=1 GOMP_CPU_AFFINITY="0-0" /home/pzou/software/software-benchmark/NPB3.3.1/NPB3.3-OMP-haswell/bin/ft.C.x > /home/pzou/projects/haswell/n02/FT/FT_${totoalPower}.data.txt
sleep 5
# totoalPower=70
# sudo /usr/local/bin/mu_power_gadget -r 10
