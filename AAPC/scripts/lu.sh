...
while [ $thNum -ge 2 ]; do
	...
	sudo OMP_NUM_THREADS=$thNum GOMP_CPU_AFFINITY="$socket1,$socket2" /home/pzou/software/software-benchmark/NPB3.3.1/NPB3.3-OMP-haswell/bin/lu.C.x > /home/pzou/projects/haswell/n02/LU/LU_${GOMP_CPU_AFFINITY}_$freq.data.txt
