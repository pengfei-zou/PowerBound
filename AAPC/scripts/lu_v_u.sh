...
# sudo /usr/local/bin/mu_power_gadget -3 38
# sudo OMP_NUM_THREADS=20 GOMP_CPU_AFFINITY="0-11,12-19" /home/pzou/software/software-benchmark/NPB3.3.1/NPB3.3-OMP-haswell/bin/lu.C.x > /home/pzou/projects/haswell/n02/LU/LU_${totoalPower}_u.data.txt
# sleep 5
...
sudo OMP_NUM_THREADS=10 GOMP_CPU_AFFINITY="0-9" /home/pzou/software/software-benchmark/NPB3.3.1/NPB3.3-OMP-haswell/bin/lu.C.x > /home/pzou/projects/haswell/n02/LU/LU_${totoalPower}_u.data.txt
sleep 5
...
# sudo /usr/local/bin/mu_power_gadget -3 26
# sudo OMP_NUM_THREADS=4 GOMP_CPU_AFFINITY="0-3" /home/pzou/software/software-benchmark/NPB3.3.1/NPB3.3-OMP-haswell/bin/lu.C.x > /home/pzou/projects/haswell/n02/LU/LU_${totoalPower}_u.data.txt
# sleep 5
