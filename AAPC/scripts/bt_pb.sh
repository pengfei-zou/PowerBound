...
while [ $thNum -ge 10 ]; do
	...
	/usr/local/bin/rapl -c 0,12 -s 0.1 -f /home/pzou/projects/haswell/n02/BT/BT_${GOMP_CPU_AFFINITY}_$power.log 2>&1 1>/dev/null &
	...
	mpirun -np 1 /home/pzou/software/software-benchmark/NPB3.3.1-MZ/NPB3.3-MZ-MPI/bin/bt-mz.C.1	> /home/pzou/projects/haswell/n02/BT/BT_${GOMP_CPU_AFFINITY}_$power.data.txt	
	pkill rapl
