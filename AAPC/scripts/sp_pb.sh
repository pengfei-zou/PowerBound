...
while [ $thNum -ge 8 ]; do
	...
	OMP_NUM_THREADS=$thNum GOMP_CPU_AFFINITY="$socket1,$socket2" /home/pzou/software/software-benchmark/NPB3.3.1/NPB3.3-OMP/bin/sp.C.x > /home/pzou/projects/haswell/n02/SP/SP_${GOMP_CPU_AFFINITY}_$power.data.txt
