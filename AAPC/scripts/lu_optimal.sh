...
# while [ $(bc <<< "$rampower >= 16") -eq 1  ]; do
	...
	# sudo OMP_NUM_THREADS=$thNum GOMP_CPU_AFFINITY="$socket1,$socket2" /home/pzou/software/software-benchmark/NPB3.3.1/NPB3.3-OMP-haswell/bin/lu.C.x > /home/pzou/projects/haswell/n02/LU/LU_${totoalPower}_${pkgpower}_${rampower}_${thNum}.data.txt
	# sleep 5
	# thNum=23
	# export OMP_NUM_THREADS=$thNum
	# socket1="0-$(((thNum-1)/2))"
