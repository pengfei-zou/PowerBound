...
# sleep 5
# totoalPower=120
# sudo /usr/local/bin/mu_power_gadget -0 6
# sudo /usr/local/bin/mu_power_gadget -1 6
# sudo /usr/local/bin/mu_power_gadget -2 63
# sudo /usr/local/bin/mu_power_gadget -3 45
# sudo OMP_NUM_THREADS=18 GOMP_CPU_AFFINITY="0-11,12-17" /home/pzou/software/software-benchmark/NPB3.3.1/NPB3.3-OMP-haswell/bin/ep.C.x > /home/pzou/projects/haswell/n02/EP/EP_${totoalPower}_u.data.txt
# sleep 5
...
# sudo /usr/local/bin/mu_power_gadget -0 6
# sudo /usr/local/bin/mu_power_gadget -1 6
# sudo /usr/local/bin/mu_power_gadget -2 60
# sudo /usr/local/bin/mu_power_gadget -3 28
# sudo OMP_NUM_THREADS=12 GOMP_CPU_AFFINITY="0-11" /home/pzou/software/software-benchmark/NPB3.3.1/NPB3.3-OMP-haswell/bin/ep.C.x > /home/pzou/projects/haswell/n02/EP/EP_${totoalPower}_u.data.txt
# sleep 5
# totoalPower=80
# sudo /usr/local/bin/mu_power_gadget -r 5.5
...
# sudo /usr/local/bin/mu_power_gadget -0 6
# sudo /usr/local/bin/mu_power_gadget -1 6
# sudo /usr/local/bin/mu_power_gadget -2 40
# sudo /usr/local/bin/mu_power_gadget -3 28
# sudo OMP_NUM_THREADS=4 GOMP_CPU_AFFINITY="0-3" /home/pzou/software/software-benchmark/NPB3.3.1/NPB3.3-OMP-haswell/bin/ep.C.x > /home/pzou/projects/haswell/n02/EP/EP_${totoalPower}_u.data.txt
# sleep 5
# totoalPower=80
# sudo /usr/local/bin/mu_power_gadget -r 6
# sudo /usr/local/bin/mu_power_gadget -p 34
# sudo OMP_NUM_THREADS=24 GOMP_CPU_AFFINITY="0-11,12-23" /home/pzou/software/mt_dgemm_haswell/mt-dgemm.o 2046 > /home/pzou/projects/haswell/n07/dgemm/dgemm_${totoalPower}_icpp.data.txt
# sleep 5
# totoalPower=60
...
sudo /usr/local/bin/mu_power_gadget -3 31
sudo OMP_NUM_THREADS=18 GOMP_CPU_AFFINITY="0-11,12-17" /home/pzou/software/mt_dgemm_haswell/mt-dgemm.o 2046 > /home/pzou/projects/haswell/n07/dgemm/dgemm_${totoalPower}_u.data.txt
sleep 5
...
sudo /usr/local/bin/mu_power_gadget -0 6
sudo /usr/local/bin/mu_power_gadget -1 6
sudo /usr/local/bin/mu_power_gadget -2 32
sudo /usr/local/bin/mu_power_gadget -3 26
sudo OMP_NUM_THREADS=10 GOMP_CPU_AFFINITY="0-9" /home/pzou/software/mt_dgemm_haswell/mt-dgemm.o 2046 > /home/pzou/projects/haswell/n07/dgemm/dgemm_${totoalPower}_u.data.txt
sleep 5
