...
# do
    ...
    # done    
# done
cd /home/pzou/software/software-benchmark/Deep_Learning_Bench/Candle/Pilot3/P3B3
bench=p3b3
...
do
    ...
    do
        ...
        python ./p3b3_baseline_keras2.py > ${results_dir}/${data}/${bench}.${freq}.${memfreq}.out10.txt
