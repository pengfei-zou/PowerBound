...
# do
    ...
    # done    
# done
cd /home/pzou/software/software-benchmark/Deep_Learning_Bench/Candle/Pilot1/TC1
bench=tc1
...
do
    ...
    do
        ...
        python ./tc1_baseline_keras2.py -e 20 > ${results_dir}/${data}/${bench}.${freq}.${memfreq}.out10.txt
